...
//  SimpsonBook
//
//  Created by Sümeyye Kılıçoğlu on 7.05.2022.
//
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var chosenSimpson : Simpson?;    override func viewDidLoad() {
        super.viewDidLoad()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = mySimpsons[indexPath.row].name;  return cell
    }
